...
step = 1
ws_timing = 11
weapon_skills = {"Tachi: Ageha", "Tachi: Yukikaze", "Tachi: Kasha", "Tachi: Shoha", "Tachi: Kasha", "Tachi: Fudo"} -- light skillchain
-- weapon_skills = {"Tachi: Ageha", "Tachi: Yukikaze", "Tachi: Kasha", "Tachi: Fudo"} -- dark skillchain
ws_cache = {
    name = "N/A",
    damage = 0,
    time = -1
