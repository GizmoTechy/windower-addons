...
data.item_fishing_parameters = {
    ...
    {name='crayfish', id=4472, stamina=21, arrow_duration=15, arrow_frequency=7, stamina_depletion=24, continent=3},
    ...
    {name='giant catfish', id=4469, stamina=33, arrow_duration=7, arrow_frequency=12, stamina_depletion=13, large=true, continent=5},
    {name='yayinbaligi', id=5463, stamina=33, arrow_duration=7, arrow_frequency=12, stamina_depletion=13, large=true, continent=2},
    ...
    {name='gugru tuna', id=4480, stamina=38, arrow_duration=7, arrow_frequency=13, stamina_depletion=16, large=true, continent=5},
    {name='lakerda', id=5450, stamina=38, arrow_duration=7, arrow_frequency=13, stamina_depletion=16, large=true, continent=2},
    ...
    {name='bhefhel marlin', id=4479, stamina=48, arrow_duration=7, arrow_frequency=15, stamina_depletion=20, large=true, continent=5},
    {name='kilicbaligi', id=5451, stamina=48, arrow_duration=7, arrow_frequency=15, stamina_depletion=18, large=true, continent=2},
    ...
    {name='king perch', id=5816, stamina=50, arrow_duration=10, arrow_frequency=8, stamina_depletion=19, large=true, continent=3},
    {name='malicious perch', id=5995, stamina=50, arrow_duration=10, arrow_frequency=8, stamina_depletion=19, large=true, continent=4},
    ...
    {name='grimmonite', id=4304, stamina=63, arrow_duration=9, arrow_frequency=7, stamina_depletion=31, large=true, continent=5},
    {name='ahtapot', id=5455, stamina=63, arrow_duration=9, arrow_frequency=7, stamina_depletion=31, large=true, continent=2},
    {name='emperor fish', id=4454, stamina=63, arrow_duration=5, arrow_frequency=13, stamina_depletion=36, large=true, continent=5},
    {name='gigant squid', id=4474, stamina=63, arrow_duration=7, arrow_frequency=10, stamina_depletion=43, large=true},
    {name='morinabaligi', id=5462, stamina=63, arrow_duration=5, arrow_frequency=13, stamina_depletion=36, large=true, continent=2},
    ...
    -- non-fish items
    --{name='gold ring', id=13445, stamina=0, arrow_duration=15, arrow_frequency=3, stamina_depletion=80},
    ...
    {name='hard-boiled egg', id=4409, stamina=20, arrow_duration=15, arrow_frequency=3, stamina_depletion=18, continent=4},
    {name='rusty subligar', id=14242, stamina=20, arrow_duration=15, arrow_frequency=3, stamina_depletion=22},
    {name='adoulinian kelp', id=3965, stamina=21, arrow_duration=15, arrow_frequency=3, stamina_depletion=18, continent=4},
    ...
    {name='damp scroll', id=1210, stamina=28, arrow_duration=15, arrow_frequency=3, stamina_depletion=35, continent=5},
    ...
    -- gil
    --{name='100 gil', id=70001, stamina=0, arrow_duration=15, arrow_frequency=3, stamina_depletion=22},
    {name='1 gil', id=70000, stamina=18, arrow_duration=15, arrow_frequency=3, stamina_depletion=22},
    -- entities
    {name='jade etui', id=70002, stamina=11, arrow_duration=11, arrow_frequency=15, stamina_depletion=16, large=true},
    -- key items
...
local function multiple(item)
    ...
    return math.floor(item.stamina * multiplier), math.floor(item.arrow_duration * multiplier), math.floor(item.arrow_frequency * multiplier)
end

local function too_large(item)
    local stamina, arrow_duration, arrow_frequency = multiple(item)
    ...
    return stamina, arrow_duration, arrow_frequency
end
...
local function format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    return table.concat({stamina, math.min(arrow_duration, 15), math.min(arrow_frequency, 15), stamina_depletion * 20}, ',')
end

data.rod_modifier_by_id = {
    [17011]=function (item)
        local stamina, arrow_duration, arrow_frequency = multiple(item)
        local stamina_depletion = math.floor(item.stamina_depletion * (item.legendary and 1.5 or 1))
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
    [17014]=function (item)
        local stamina, arrow_duration, arrow_frequency = too_large(item)
        local stamina_depletion = math.floor(item.stamina_depletion * 1.25)
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
    [17015]=function (item)
        local stamina, arrow_duration, arrow_frequency = too_large(item)
        return format_uid(stamina, arrow_duration, arrow_frequency, item.stamina_depletion)
    end,
    [17380]=function (item)
        local stamina, arrow_duration, arrow_frequency = too_small(item)
        local stamina_depletion = math.floor(item.stamina_depletion * 1.3)
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
    [17381]=function (item)
        local stamina, arrow_duration, arrow_frequency = too_small(item)
    ...
    [17383]=function (item)
        local stamina, arrow_duration, arrow_frequency = too_small(item)
        local stamina_depletion = math.floor(item.stamina_depletion * 1.7)
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
    [17384]=function (item)
        local stamina, arrow_duration, arrow_frequency = multiple(item)
    ...
    [17386]=function (item)
        local stamina, arrow_duration, arrow_frequency = multiple(item)
        local stamina_depletion = math.floor(item.stamina_depletion * (item.legendary and 1.3 or 1.1))
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
    [17387]=function (item)
        local stamina, arrow_duration, arrow_frequency = multiple(item)
    ...
    [17388]=function (item)
        local stamina, arrow_duration, arrow_frequency = multiple(item)
        local stamina_depletion = math.floor(item.stamina_depletion * 1.35)
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
    [17389]=function (item)
        local stamina, arrow_duration, arrow_frequency = multiple(item)
        local stamina_depletion = math.floor(item.stamina_depletion * 1.4)
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
    [17390]=function (item)
        local stamina, arrow_duration, arrow_frequency = multiple(item)
        local stamina_depletion = math.floor(item.stamina_depletion * 1.45)
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
    [17391]=function (item)
        local stamina, arrow_duration, arrow_frequency = multiple(item)
        local stamina_depletion = math.floor(item.stamina_depletion * 1.5)
        return format_uid(stamina, arrow_duration, arrow_frequency, stamina_depletion)
    end,
}
...
data.rod_modifier_by_id[19319] = data.rod_modifier_by_id[17384]
